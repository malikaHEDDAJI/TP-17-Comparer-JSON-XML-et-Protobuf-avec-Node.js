...
let jsonData = JSON.stringify(jsonObject, null, 4); 
...
// ----------- Verification symétrie Protobuf -----------

console.time("Protobuf re-decode");

// Lire depuis fichier
let protoBuffer = fs.readFileSync("data.proto");

// Décoder à nouveau
let decodedAgain = EmployeeList.decode(protoBuffer);
let backToObject = EmployeeList.toObject(decodedAgain);

console.timeEnd("Protobuf re-decode");

console.log("Objet relu depuis data.proto :");
